...
public class OlympicTable {
   ...
   for (String myteams : list) {
	...
	String gold = "//span[text()='"+myteams +"']/../following-sibling::div[1]";
	String silver1="//span[text()='"+myteams +"']/../following-sibling::div[2]";
	String bronze1 = "//span[text()='"+myteams +"']/../following-sibling::div[3]";
	String total = "//span[text()='"+myteams +"']/../following-sibling::div[4]";
}
